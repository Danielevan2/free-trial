        ...
        export default {
            ...
            methods: {
                        ...
                        this.transaksi.total = this.subTotal
                            Swal.fire({
                                ...
                                if (result.isConfirmed) {
                                    ...
                                    if(this.supName){
                                        tempData.customer = this.supId
                                    }
                                

                                    axios({
                                    url: `https://free-trial-b6eefb5f026f.herokuapp.com/transaksi/penjualan`,
                                    method: 'post',
                                    headers:{
                ...
                searchSupplier(page){       
                    ...
                    axios({
                        url: `${this.$store.state.url}/customer/search?src=${this.src}`,
                        method: 'get',
                        headers:{
                            token : localStorage.getItem('token')
                        }
