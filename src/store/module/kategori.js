...
const actions = {
  fetchKategori(context,payload,limit) {
      ...
      axios({
        url: `https://free-trial-b6eefb5f026f.herokuapp.com/kategori`,
        method: 'get',
        headers:{
  ...
  fetchMerkMobil(context,payload,limit) {
    ...
    axios({
      url: `https://free-trial-b6eefb5f026f.herokuapp.com/kategori/mobil`,
      method: 'get',
      headers:{
          token : localStorage.getItem('token')
      }
  ...
  fetchMerkKaca(context,payload,limit) {
    ...
    axios({
      url: `https://free-trial-b6eefb5f026f.herokuapp.com/kategori/kaca`,
      method: 'get',
      headers:{
          token : localStorage.getItem('token')
      }
